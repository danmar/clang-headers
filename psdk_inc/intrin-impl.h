...
//dm__INTRINSICS_USEINLINE 
//dm__buildlogicali(_InterlockedAnd64, __int64, and)
...
//dm__INTRINSICS_USEINLINE 
//dm__buildlogicali(_InterlockedOr64, __int64, or)
...
//dm__INTRINSICS_USEINLINE 
//dm__buildlogicali(_InterlockedXor64, __int64, xor)
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE 
//dm__int64 _InterlockedIncrement64(__int64 volatile *Addend) {
//dm    return __sync_add_and_fetch(Addend, 1);
//dm}
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE 
//dm__int64 _InterlockedDecrement64(__int64 volatile *Addend) {
//dm    return __sync_sub_and_fetch(Addend, 1);
//dm}
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE 
//dm__int64 _InterlockedExchange64(__int64 volatile *Target, __int64 Value) {
//dm    return __sync_lock_test_and_set(Target, Value);
//dm}
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE 
//dm__int64 _InterlockedExchangeAdd64(__int64 volatile *Addend, __int64 Value) {
//dm    return __sync_fetch_and_add(Addend, Value);
//dm}
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE
//dm__buildbitscan(_BitScanForward64, unsigned __int64, "bsf{q %[Mask],%[Index] | %[Index],%[Mask]}")
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE
//dm__buildbitscan(_BitScanReverse64, unsigned __int64, "bsr{q %[Mask],%[Index] | %[Index],%[Mask]}")
...
//dm__INTRINSICS_USEINLINE 
//dm__buildlogicali(_InterlockedAnd, __LONG32, and)
...
//dm__INTRINSICS_USEINLINE 
//dm__buildlogicali(_InterlockedOr, __LONG32, or)
...
//dm__INTRINSICS_USEINLINE 
//dm__buildlogicali(_InterlockedXor, __LONG32, xor)
...
//dm__INTRINSICS_USEINLINE 
//dmshort _InterlockedIncrement16(short volatile *Addend) {
//dm    return __sync_add_and_fetch(Addend, 1);
//dm}
...
//dm__INTRINSICS_USEINLINE 
//dmshort _InterlockedDecrement16(short volatile *Addend) {
//dm    return __sync_sub_and_fetch(Addend, 1);
//dm}
...
//dm__INTRINSICS_USEINLINE 
//dmshort _InterlockedCompareExchange16(short volatile *Destination, short ExChange, short Comperand) {
//dm    return __sync_val_compare_and_swap(Destination, Comperand, ExChange);
//dm}
...
//dm__MINGW_EXTENSION __INTRINSICS_USEINLINE 
//dm__int64 _InterlockedCompareExchange64(__int64 volatile *Destination, __int64 ExChange, __int64 Comperand) {
//dm    return __sync_val_compare_and_swap(Destination, Comperand, ExChange);
//dm}
...
//dm__INTRINSICS_USEINLINE
//dm__buildstos(__stosb, unsigned char, "b|b")
...
//dm__INTRINSICS_USEINLINE 
//dm__buildbitscan(_BitScanForward, unsigned __LONG32, "bsf{l %[Mask],%[Index] | %[Index],%[Mask]}")
...
//dm__INTRINSICS_USEINLINE 
//dm__buildbitscan(_BitScanReverse, unsigned __LONG32, "bsr{l %[Mask],%[Index] | %[Index],%[Mask]}")
